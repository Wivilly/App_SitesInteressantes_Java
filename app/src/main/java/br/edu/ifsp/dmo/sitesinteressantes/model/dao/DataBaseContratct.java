...
public final class DataBaseContratct {
    private DataBaseContratct(){}
    ...
    public static class TableTag implements BaseColumns{
        ...
        public static final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " ( " + _ID + " INTEGER PRIMARY KEY, " + COLUMN_TAG + " TEXT UNIQUE)";
    }
}
